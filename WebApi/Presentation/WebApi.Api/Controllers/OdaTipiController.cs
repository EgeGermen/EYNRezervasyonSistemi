...
namespace WebApi.Api.Controllers
{
    ...
    public class OdaTipiController : ControllerBase
    {
        ...
        public async Task<ActionResult<IEnumerable<OdaTipiDto>>> GetAll()
        {
            ...
            return Ok(odaTipleri.Select(o => new OdaTipiDto { Id = o.Id, OdaTipiAdi = o.OdaTipiAdi, Kapasite = o.Kapasite, Fiyat = o.Fiyat, OtelId = o.OtelId }));
        }
        ...
        public async Task<ActionResult<OdaTipiDto>> GetById(int id)
        {
            ...
            return Ok(new OdaTipiDto { Id = o.Id, OdaTipiAdi = o.OdaTipiAdi, Kapasite = o.Kapasite, Fiyat = o.Fiyat, OtelId = o.OtelId });
        }
        ...
        public async Task<ActionResult<OdaTipiDto>> Create([FromBody] OdaTipiCreateDto dto)
        {
            ...
            var odaTipi = new OdaTipi { OdaTipiAdi = dto.OdaTipiAdi, Kapasite = dto.Kapasite, Fiyat = dto.Fiyat, OtelId = dto.OtelId, Aciklama = dto.Aciklama };
            var yen = await _service.YeniOdaTipiOlusturAsync(odaTipi);
            return CreatedAtAction(nameof(GetById), new { id = yen.Id }, new OdaTipiDto { Id = yen.Id, OdaTipiAdi = yen.OdaTipiAdi, Kapasite = yen.Kapasite, Fiyat = yen.Fiyat, OtelId = yen.OtelId });
        }
